...
export class KeycloakAuthService implements AuthService {
  ...
  public async init(): Promise<boolean> {
    ...
    const enableSilentSSOCheck =
      this.configService.getProperty(CONFIG_KEY.KEYCLOAK_ENABLE_SILENT_SSO) ===
      'true';
  ...
  protected getValidKCConfig(): KeycloakConfig {
    // TODO: In MyCustomAuth überschreiben, mit @Override
    const clientId = this.configService.getProperty(
